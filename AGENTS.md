...
- Use concise, imperative subjects (for example, "Update winget packages for Windows tools").
...
- Windows provisioning uses `winget`; call out changes to `windows/` assets in PRs.
